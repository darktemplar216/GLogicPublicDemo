...
namespace BridgeNodes.LMN
{
    ...
    /// 本身挂接在NLogicCore
    /// </summary>
    public class X2NBridge : ObjLogicNode
    {
        private X2NBridge() : base()
        {
            //我是一个线程安全节点//
        ...
        private static X2NBridge mInstance = null;
        
        public static X2NBridge Instance
        {
            get
            {
                return mInstance;
